...
"""Verify that starting phoenixsiv with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start phoenixsiv with -h for help text")
        ...
        self.log.info("Start phoenixsiv with -version for version information")
