...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s phoenixsiv-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  phoenixsiv-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded phoenixsiv transaction") + "\n" +
              "  phoenixsiv-tx [options] -create [commands]   " + _("Create hex-encoded phoenixsiv transaction") + "\n" +
              "\n";
